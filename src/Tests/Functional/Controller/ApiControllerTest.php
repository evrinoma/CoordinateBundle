...
namespace Evrinoma\CoordinateBundle\Tests\Functional\Controller;

use Evrinoma\CoordinateBundle\Fixtures\FixtureInterface;
...
{
    protected string $actionServiceName = 'evrinoma.coordinate.test.functional.action.coordinate';
    ...
    {
        return [FixtureInterface::COORDINATE_FIXTURES];
    }
}
